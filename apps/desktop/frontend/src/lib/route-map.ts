 ...
 *
 * Desktop adaptation: Same route map as Web — the Desktop app
 * renders the same views via React Router or hash-based navigation.
 */
export const viewToUrl: Record<ViewName, string> = {
  ...
  'agency-fullscreen': '/fullscreen',
  'agency-fullscreen-history': '/fullscreen/history',
