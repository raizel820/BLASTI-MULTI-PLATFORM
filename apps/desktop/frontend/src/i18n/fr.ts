...
const fr: Record<TranslationKeys, string> = {
  ...
  // DUPLICATE REMOVED: close: "Fermer",
  ...
  notificationTypeWarning: "Avertissement",
  notificationTypeError: "Erreur",
  notificationTypeTurn: "Tour",
  ...
  // DUPLICATE REMOVED: autoRefresh: "Actualisation automatique toutes les 10s",
  ...
  // DUPLICATE REMOVED: confirmed: "Confirmé",
  ticket: "Ticket",
 ...
 faqFreeTrial: 'Y a-t-il un essai gratuit ?',
  ...
  // DUPLICATE REMOVED: shareTicket: 'Partager le ticket',
  ...
  // DUPLICATE REMOVED: counterNumber: 'Guichet n°',
  ...
  // DUPLICATE REMOVED: peakHour: 'Heure de pointe',
  ...
  yearly: 'Annuel',
  oneTime: 'Unique',
  // DUPLICATE REMOVED: maxServices: 'Services max',
  maxBranches: 'Filiale max',
  // DUPLICATE REMOVED: maxStaff: 'Personnel max',
  // DUPLICATE REMOVED: maxReservations: 'Réservations max',
  maxSmsPerMonth: 'SMS max/mois',
  features: 'Fonctionnalités',
  // DUPLICATE REMOVED: kioskModeEnabled: 'Mode borne',
  ...
  // DUPLICATE REMOVED: customBranding: 'Marque personnalisée',
  customBrandingDesc: 'Logo, couleurs et marque personnalisés pour l\'établissement',
  // DUPLICATE REMOVED: apiAccess: 'Accès API',
  ...
  statNoChange: 'stable',
  // DUPLICATE REMOVED: memoryUsage: 'Mémoire',
  // DUPLICATE REMOVED: cpuUsage: 'CPU',
  // DUPLICATE REMOVED: diskUsage: 'Disque',
  ...
  // DUPLICATE REMOVED: seconds: 'secondes',
  healthScore: 'Score de santé',
  uptimePercent: 'Disponibilité',
  // DUPLICATE REMOVED: responseTime: 'Temps de réponse',
  planDistribution: 'Répartition des plans',
  ofTotal: 'du total',
  freePlan: 'Gratuit',
  // DUPLICATE REMOVED: basicPlan: 'Basique',
  proPlan: 'Pro',
  // DUPLICATE REMOVED: enterprisePlan: 'Entreprise',
  noPlanData: 'Aucune donnée d\'abonnement disponible',
  createAnn: 'Créer',
  pinAnn: 'Épingler',
  unpinAnn: 'Désépingler',
  // DUPLICATE REMOVED: pinned: 'Épinglé',
  annTypeInfo: 'Info',
  ...
  // DUPLICATE REMOVED: off: 'Arrêt',
  refreshNow: 'Actualiser',
  // DUPLICATE REMOVED: lastRefreshed: 'Dernière actualisation',

  // ─── Customer Enhanced Views (Task 6) ────
  // DUPLICATE REMOVED: quickStats: 'Statistiques rapides',
  ...
  // DUPLICATE REMOVED: queueProgress: 'Progression',
  positionLabel: 'Position',
  ofLabel: 'sur',
  // DUPLICATE REMOVED: sharePosition: 'Partager la position',
  shareCopied: 'Position copiée !',
  // DUPLICATE REMOVED: leaveQueueConfirm: 'Quitter la file ?',
  // DUPLICATE REMOVED: leaveQueueWarning: 'Vous perdrez votre position dans la file. Cette action est irréversible.',
  ...
  // DUPLICATE REMOVED: filterByDate: 'Filtrer par date',
  dateRange: 'Plage de dates',
  // DUPLICATE REMOVED: last7Days: '7 derniers jours',
  // DUPLICATE REMOVED: last30Days: '30 derniers jours',
  last3Months: '3 derniers mois',
  allTime: 'Tout le temps',
  // DUPLICATE REMOVED: statusServed: 'Servi',
  // DUPLICATE REMOVED: statusCancelled: 'Annulé',
  // DUPLICATE REMOVED: statusNoShow: 'Absent',
  // DUPLICATE REMOVED: markAllRead: 'Tout marquer comme lu',
  allNotificationsRead: 'Tout est à jour !',
  // DUPLICATE REMOVED: noNotificationsDesc: 'Vous n\'avez aucune notification pour le moment. Nous vous informerons quand quelque chose se produit.',
  readMore: 'Lire plus',
  ...
  // DUPLICATE REMOVED: optional: 'Facultatif',
  ...
  // DUPLICATE REMOVED: noHardwareOrders: 'Aucune commande de matériel pour le moment.',
  noHardwareOrdersPending: 'Aucune commande de matériel en attente.',
  viewOrderDetails: 'Voir les détails',
  orderDetails: 'Détails de la commande',
  // DUPLICATE REMOVED: totalBasePrice: 'Prix de base total',
  monthlyExtraCost: 'Supplément mensuel',
  upfrontTotal: 'Total comptant',
  // DUPLICATE REMOVED: commitmentPeriod: 'Période d\'engagement',
  // DUPLICATE REMOVED: months: 'mois',
  orderStatus: 'Statut',
  agencyInfo: 'Informations sur l\'agence',
  // DUPLICATE REMOVED: quantity: 'Qté',
  ...
  na: 'N/A',
  // DUPLICATE REMOVED: page: 'Page',
  // DUPLICATE REMOVED: of: 'sur',
  prev: 'Précédent',
  // DUPLICATE REMOVED: next: 'Suivant',
  ...
  // DUPLICATE REMOVED: statusCompleted: 'Terminé',
  // DUPLICATE REMOVED: statusCancelled: 'Annulé',
  statusServing: 'En service',
  // DUPLICATE REMOVED: statusWaiting: 'En attente',
  // DUPLICATE REMOVED: statusCalled: 'Appelé',
  // DUPLICATE REMOVED: statusNoShow: 'Absent',
  ...
  // DUPLICATE REMOVED: statusServing: 'En service',
  ...
  // ─── Service Management (Desktop Services Page) ──────────────
  searchServices: 'Rechercher des services...',
  serviceNameRequired: 'Le nom du service est requis',
  serviceNameMinLength: 'Le nom du service doit contenir au moins 2 caractères',
  servicePrefixRequired: 'Le préfixe du service est requis',
  serviceDurationRange: 'La durée doit être entre 1 et 999 minutes',
  serviceCapacity: 'Capacité du service',
  serviceCapacityDesc: 'Réservations simultanées maximales pour ce service',
  serviceCapacityRange: 'La capacité doit être entre 1 et 500',
  serviceDescriptionPlaceholder: 'Brève description de ce service...',
  serviceActiveDesc: 'Activer ou désactiver ce service pour la file d\'attente',
  allowWalkIn: 'Autoriser sans réservation',
  allowWalkInDesc: 'Autoriser les clients à rejoindre sans réservation',
  autoCompleteService: 'Auto-complétion',
  autoCompleteDesc: 'Marquer automatiquement le service comme terminé après la durée estimée',
  autoComplete: 'Auto',
  serviceActivated: 'Service activé',
  serviceDeactivated: 'Service désactivé',
  confirmDeleteNotificationDesc: 'Êtes-vous sûr de vouloir supprimer cette notification ?',
  confirmDeleteAnnouncementDesc: 'Êtes-vous sûr de vouloir supprimer cette annonce ?',
  confirmDeleteService: 'Supprimer le service ?',
  confirmDeleteServiceDesc: 'Êtes-vous sûr de vouloir supprimer',
  confirmDeleteServiceEnd: ' ? Cette action est irréversible.',
  noSearchResults: 'Aucun service ne correspond à votre recherche',
  inEnglish: 'Anglais',

  // ─── Queue Page ──────────────────────
  queuePageDesc: 'Gérez votre file d\'attente, guichets et flux de clients',
  beingServed: 'En service',
  walkInDialogDesc: 'Ajouter un client sans réservation à la file',
