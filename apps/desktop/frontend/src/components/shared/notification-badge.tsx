...
// Desktop shims for api-client availability checks (Web uses these for
// offline-aware polling). In Desktop, we always assume the local API is
// reachable — if it isn't, apiFetch returns a 503 Response.
function isApiUnreachable(): boolean {
  return false;
}
function isBothUnreachable(): boolean {
  return false;
}
